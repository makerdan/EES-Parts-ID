...
const ADMIN_HELP: Array<HelpRecord> = [
  {
    ...
    title: "Measure part dimensions",
    summary: "Capture and review a part's physical dimensions.",
    body: "The Measure workflow is available to administrators. Measurements can pre-fill an item's dimensions or become a Search size-range filter.",
    prerequisites: ["A current approved-administrator session", "An item edit form or a Search workflow"],
    steps: [
      "Open Measure from an item edit form or the admin-enabled measurement entry point.",
      "Capture dimensions and review the values.",
    ...
    limitations: ["Captured values require human verification."],
    revision: { contentVersion: HELP_CONTENT_VERSION, revisedAt: "2026-09-01", source: "verified-product-workflow" },
  },
  {
