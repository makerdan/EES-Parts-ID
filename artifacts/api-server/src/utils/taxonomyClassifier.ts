...
export const CLASSIFIER_RULES: Rule[] = [
  ...
  { typeSlug: "hvac-thermostat", anyKeywords: ["thermostat", "t-stat", "programmable thermostat", "smart thermostat", "heat pump thermostat"] },
  { typeSlug: "hvac-contactor", anyKeywords: ["hvac contactor", "compressor contactor", "ac contactor", "hvac relay"] },
  { typeSlug: "hvac-control-other", anyKeywords: ["hvac control", "defrost control", "hvac board"] },
  { typeSlug: "hvac-motor", anyKeywords: ["hvac motor", "blower motor", "condenser fan motor", "evaporator motor", "ecm motor"] },
  { typeSlug: "hvac-capacitor", anyKeywords: ["run capacitor", "start capacitor", "dual round capacitor", "hvac capacitor"] },
  { typeSlug: "hvac-component-other", anyKeywords: ["hvac component", "air handler", "condenser"] },
  { typeSlug: "hvac-disconnect-switch", anyKeywords: ["ac disconnect", "hvac disconnect", "air conditioner disconnect", "ac unit disconnect"] },
  { typeSlug: "hvac-fuse-block", anyKeywords: ["fuse block", "fuse holder", "fuse pull out", "pullout fuse"] },
  { typeSlug: "hvac-protection-other", anyKeywords: ["hvac fuse", "hvac breaker", "hvac protection"] },
  ...
  { typeSlug: "wire-control", anyKeywords: ["control cable", "instrumentation cable", "shielded control cable", "tffn control"], catalogPattern: /^(TC|TRAY|18\/\d|16\/\d|14\/\d)\s/i },
  { typeSlug: "wire-tray", anyKeywords: ["tray cable", "tc cable", "power limited tray"], catalogPattern: /^(TC-ER|TRAY-|PLTC)/i },
  { typeSlug: "wire-welding", anyKeywords: ["welding cable", "welding lead", "battery cable", "booster cable"], catalogPattern: /WELD|BATT-CABLE/i },
  // Note: "thermostat wire" excluded here — hvac-thermostat already catches it above
  { typeSlug: "wire-low-voltage", anyKeywords: ["thermostat wire", "low voltage wire", "18 2 wire", "18-2 wire", "thermostat cable", "hvac wire"], catalogPattern: /^(18\/2|18-2|20\/2|20-2|THERM)/i },
  { typeSlug: "wire-specialty-other", anyKeywords: ["specialty cable", "fire alarm cable", "security cable", "audio cable", "speaker wire"] },

  // Line construction wire (before wire-other)
  { typeSlug: "wire-triplex", anyKeywords: ["triplex", "quadruplex", "urd triplex", "secondary urd"], catalogPattern: /TRIPLEX|QUAD[RU]|URD-/i },
  { typeSlug: "wire-aac", anyKeywords: ["aac cable", "acsr", "overhead conductor", "aluminum conductor"], catalogPattern: /^AAC|^ACSR/i },
  { typeSlug: "wire-overhead-other", anyKeywords: ["overhead wire", "span wire", "messenger wire"] },

  // Telecom cable (before wire-other which matches "cable")
  { typeSlug: "cable-cat5e", anyKeywords: ["cat 5e", "cat5e", "category 5e", "category5e"], catalogPattern: /CAT5E|CAT-5E/i },
  { typeSlug: "cable-cat6", anyKeywords: ["cat 6", "cat6", "cat 6a", "cat6a", "category 6"], catalogPattern: /CAT6|CAT-6/i },
  { typeSlug: "cable-fiber", anyKeywords: ["fiber optic", "fibre optic", "optical fiber", "om3 fiber", "om4 fiber", "single mode fiber"], catalogPattern: /FIBER|FIBRE|OPTICAL/i },
  { typeSlug: "cable-coax", anyKeywords: ["coaxial cable", "coax cable", "rg6 cable", "rg11 cable", "rg59 cable"], catalogPattern: /RG6|RG11|RG59|COAX/i },
  { typeSlug: "cable-telecom-other", anyKeywords: ["plenum cable", "riser cable", "cmp cable", "cmr cable", "data cable"] },
  ...
  { typeSlug: "fitting-liquidtight-connector", anyKeywords: ["liquidtight connector", "liquid tight connector", "lfmc connector", "watertight connector"], catalogPattern: /LT-|LTFMC|LIQT/i },
  { typeSlug: "fitting-liquidtight-other", anyKeywords: ["liquidtight fitting", "liquid tight fitting"] },
  ...
  { typeSlug: "wireway-metal", anyKeywords: ["wireway", "wiring duct", "panduit duct", "metal duct"] },
  { typeSlug: "cable-tray-ladder", anyKeywords: ["ladder tray", "cable tray ladder"] },
  { typeSlug: "cable-tray-solid", anyKeywords: ["solid bottom tray", "solid tray", "cable tray solid"] },
  ...
  { typeSlug: "fitting-connector", anyKeywords: ["conduit connector", "compression connector", "set screw connector"] },
  ...
  { typeSlug: "fitting-ground-rod", anyKeywords: ["ground rod", "grounding rod", "copper clad ground rod", "ground electrode"], catalogPattern: /GR-|GND-ROD/i },
  { typeSlug: "fitting-ground-connector", anyKeywords: ["grounding clamp", "ground clamp", "acorn clamp", "grounding connector", "bonding connector", "ground lug"], catalogPattern: /GBMC|GBC\d|GRND/i },
  { typeSlug: "fitting-ground-other", anyKeywords: ["grounding fitting", "bonding fitting", "ground bushing", "bonding bushing"] },
  // Reducers (before fitting-other which catches "reducer", "bushing")
  { typeSlug: "fitting-reducer", anyKeywords: ["conduit reducer", "reducing bushing", "conduit adapter", "emt to rigid", "chase nipple"] },
  ...
  { typeSlug: "surge-protector-panel", anyKeywords: ["whole house surge", "panel surge", "service entrance surge", "type 1 spd", "type 2 spd"] },
  { typeSlug: "surge-protector-point", anyKeywords: ["surge strip", "surge protector", "point of use surge"] },
  ...
  { typeSlug: "timer-switch", anyKeywords: ["timer switch", "astronomic timer", "time clock", "mechanical timer"] },
  // Disconnects containing "disconnect switch" / "safety switch" — must precede switch-other
  { typeSlug: "disconnect-fusible", anyKeywords: ["fusible safety switch", "fusible disconnect", "fusible switch"] },
  { typeSlug: "disconnect-nonfusible", anyKeywords: ["non-fusible", "nonfusible", "safety disconnect", "disconnect switch"] },
  ...
  { typeSlug: "cover-wallplate", anyKeywords: ["wall plate", "wallplate", "device plate", "faceplate", "decorator plate", "midway plate", "screwless plate"] },
  { typeSlug: "cover-weatherproof", anyKeywords: ["in use cover", "in-use cover", "weatherproof cover", "while-in-use cover"] },
  { typeSlug: "cover-box-cover", anyKeywords: ["extension ring", "box cover", "mud ring", "raised cover"] },
  { typeSlug: "cover-other", anyKeywords: ["cover plate", "cover"] },
  // NEMA enclosures (before box-other which catches "enclosure")
  { typeSlug: "enclosure-nema1", anyKeywords: ["nema 1", "nema1", "indoor enclosure", "general duty enclosure"] },
  { typeSlug: "enclosure-nema3r", anyKeywords: ["nema 3r", "nema3r", "rainproof enclosure", "outdoor enclosure 3r"] },
  { typeSlug: "enclosure-nema4", anyKeywords: ["nema 4x", "nema4x", "nema 4", "nema4", "watertight enclosure", "stainless enclosure"], catalogPattern: /N4X|NEMA4/i },
  ...
  { typeSlug: "lighting-emergency-unit", anyKeywords: ["emergency light", "emergency lighting unit", "bug eye light", "emergency backup"] },
  { typeSlug: "lighting-emergency-other", anyKeywords: ["emergency egress", "emergency luminaire"] },
  // Lighting controls (before lighting-other which catches "light")
  { typeSlug: "lighting-ctrl-daylight", anyKeywords: ["daylight sensor", "astronomical timer", "dusk to dawn", "photocell control"] },
  { typeSlug: "lighting-ctrl-motion", anyKeywords: ["motion sensor light", "motion control", "occupancy controlled lighting", "pir sensor"] },
  { typeSlug: "lighting-ctrl-dimmer", anyKeywords: ["lighting dimmer", "0-10v dimmer", "trailing edge dimmer", "leading edge dimmer"] },
  { typeSlug: "lighting-ctrl-other", anyKeywords: ["lighting control", "light control", "daylight control"] },
  // Standard fixture types ("exit sign" removed — now handled by lighting-exit-sign above)
  { typeSlug: "lighting-fixture", anyKeywords: ["fixture", "luminaire", "troffer", "high bay", "wall pack"] },
  ...
  { typeSlug: "connector-beam-clamp", anyKeywords: ["beam clamp", "pipe clamp", "c-clamp", "i-beam clamp"] },
  { typeSlug: "connector-cable-tray-conn", anyKeywords: ["cable tray connector", "tray splice plate"] },
  { typeSlug: "connector-strut-conn", anyKeywords: ["strut fitting", "unistrut fitting", "superstrut", "strut connector", "channel nut", "framing connector"] },
  { typeSlug: "connector-structural-other", anyKeywords: ["structural connector", "post base", "joist hanger"] },
  // Telecom jacks (before connector-other which catches "connector")
  { typeSlug: "jack-rj45", anyKeywords: ["rj45", "rj-45", "keystone jack", "keystone module", "ethernet jack"] },
  { typeSlug: "jack-coax", anyKeywords: ["f connector", "coax connector", "coax splitter", "rg6 connector", "f-type"] },
  { typeSlug: "jack-other", anyKeywords: ["data jack", "voice jack", "telecom jack", "rj11", "rj-11"] },
  // Catch-all
  ...
  { typeSlug: "relay-control", anyKeywords: ["control relay", "ice cube relay", "dpdt relay", "spdt relay"] },
  ...
  { typeSlug: "sensor-current", anyKeywords: ["current sensor", "ct clamp", "current transformer", "current transducer"] },
  { typeSlug: "sensor-other", anyKeywords: ["sensor", "transducer", "detector"] },
  { typeSlug: "pilot-pushbutton", anyKeywords: ["push button", "pushbutton", "momentary button", "e-stop button"] },
  { typeSlug: "pilot-indicator", anyKeywords: ["pilot light", "indicator light", "stack light", "tower light"] },
  ...
  { typeSlug: "strut-channel", anyKeywords: ["strut channel", "unistrut", "superstrut", "b-line channel", "framing channel"], catalogPattern: /^(P1000|P1001|B22|B12)/i },
  { typeSlug: "strut-fitting", anyKeywords: ["strut fitting", "strut nut", "channel nut", "strut clamp", "unistrut nut"] },
  { typeSlug: "strut-other", anyKeywords: ["strut", "framing rail", "slotted channel"] },
  { typeSlug: "cable-tie", anyKeywords: ["cable tie", "zip tie", "tie wrap", "wire tie", "nylon tie"] },
  { typeSlug: "cable-staple", anyKeywords: ["cable staple", "cable clip", "wire staple", "romex staple", "nm staple"] },
  { typeSlug: "cable-duct", anyKeywords: ["cable duct", "wiring duct", "wire management duct"] },
  { typeSlug: "cable-management-other", anyKeywords: ["cable management", "wire loom", "split loom", "corrugated loom"] },
  { typeSlug: "hanger-rod", anyKeywords: ["hanger rod", "all-thread hanger", "drop rod", "support rod"] },
  { typeSlug: "hanger-beam", anyKeywords: ["beam hanger", "trapeze hanger", "trapeze support"] },
  { typeSlug: "hanger-pipe", anyKeywords: ["pipe hanger", "pipe clamp", "pipe strap", "conduit hanger"] },
  { typeSlug: "hanger-other", anyKeywords: ["hanger", "support bracket", "j hook", "j-hook"] },

  // ── LINE CONSTRUCTION
  { typeSlug: "pole-insulator", anyKeywords: ["insulator", "pin insulator", "spool insulator", "strain insulator"] },
  { typeSlug: "pole-clamp", anyKeywords: ["deadend clamp", "strain clamp", "guy clamp", "dead end"] },
  { typeSlug: "pole-hardware-other", anyKeywords: ["pole hardware", "crossarm", "pole band", "bolt machine"] },
  { typeSlug: "urd-cable", anyKeywords: ["urd cable", "underground distribution cable", "15kv cable", "25kv cable", "35kv cable"] },
  { typeSlug: "urd-splice", anyKeywords: ["urd splice", "cable splice kit", "inline splice", "termination kit"], catalogPattern: /SPLICE|TERM-KIT/i },
  { typeSlug: "urd-other", anyKeywords: ["underground distribution", "pad mount", "elbow connector medium voltage"] },

  // ── TELECOM — patch panels & enclosures
  { typeSlug: "patch-panel", anyKeywords: ["patch panel", "24 port panel", "48 port panel", "cat6 panel", "cat5e panel"] },
  { typeSlug: "telecom-enclosure", anyKeywords: ["telecom enclosure", "data enclosure", "network enclosure", "wall mount rack", "patch enclosure"] },
  { typeSlug: "telecom-enclosure-other", anyKeywords: ["network rack", "server rack", "cable management panel"] },

  // ── TOOLS & TESTERS
  { typeSlug: "tool-pliers", anyKeywords: ["lineman pliers", "needle nose pliers", "wire stripper", "wire cutter", "diagonal cutter", "side cutter"], catalogPattern: /^(J2000|J45|J939|NP)/i },
  { typeSlug: "tool-screwdriver", anyKeywords: ["screwdriver", "nut driver", "hex driver", "insulated driver", "torque driver"] },
  { typeSlug: "tool-fish-tape", anyKeywords: ["fish tape", "pulling tape", "pull wire", "fish wire", "wire puller tape"] },
  { typeSlug: "tool-conduit-bender", anyKeywords: ["conduit bender", "pipe bender", "hickey bender", "emt bender"] },
  { typeSlug: "tool-hand-other", anyKeywords: ["crimper", "punch tool", "knockout punch", "ratchet crimper", "wire mesh grip"] },
  { typeSlug: "tester-multimeter", anyKeywords: ["multimeter", "digital multimeter", "dmm", "fluke multimeter", "voltmeter"] },
  { typeSlug: "tester-clamp-meter", anyKeywords: ["clamp meter", "amp clamp", "clamp on meter", "current clamp"] },
  { typeSlug: "tester-circuit", anyKeywords: ["circuit tester", "voltage tester", "voltage detector", "non-contact tester", "solenoid tester"] },
  { typeSlug: "tester-continuity", anyKeywords: ["continuity tester", "wire tester", "cable tester", "tone generator", "toner probe"] },
  { typeSlug: "tester-other", anyKeywords: ["power quality meter", "insulation tester", "megohmmeter", "ir thermometer"] },
  { typeSlug: "tool-drill-bit", anyKeywords: ["drill bit", "hole saw", "spade bit", "auger bit", "ship auger"] },
  { typeSlug: "tool-blade", anyKeywords: ["saw blade", "reciprocating blade", "jig saw blade", "cutting wheel", "abrasive disc"] },
  { typeSlug: "tool-power-acc-other", anyKeywords: ["power tool accessory", "impact socket", "extension bar", "right angle drill"] },
  ...
  { typeSlug: "anchor-concrete", anyKeywords: ["concrete anchor", "masonry anchor", "wedge anchor", "sleeve anchor", "drop-in anchor"], catalogPattern: /RAWL|HILTI|TAPCON/i },
  { typeSlug: "anchor-toggle", anyKeywords: ["toggle bolt", "hollow wall anchor", "molly bolt", "wall anchor"] },
  { typeSlug: "anchor-threaded-rod", anyKeywords: ["threaded rod", "all thread", "allthread", "stud rod"] },
  { typeSlug: "anchor-other", anyKeywords: ["anchor", "fastener", "lag bolt", "hex bolt", "machine screw", "self-tapping screw", "sheet metal screw"] },
];
