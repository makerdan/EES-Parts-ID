...
function makeHost(tag) {
  return React.forwardRef((props, ref) => {
    const { children, style, accessibilityLabel, accessibilityRole, accessibilityState, ...rest } = props;
    const a11y = {};
...
const Pressable = React.forwardRef((props, ref) => {
  const { onPress, children, accessibilityLabel, accessibilityRole, accessibilityState, ...rest } = props;
  ...
  return React.createElement(
    "button",
    { ref, type: "button", onClick: onPress, role: accessibilityRole ?? "button", ...a11y, ...rest },
